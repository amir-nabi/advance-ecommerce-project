    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
          ...
          @if(session()->get('language') == 'arabic') {{ $category->category_name_ar }} @else {{ $category->category_name_eng }} @endif
                          </a>
           ...
           <h2 class="title">
          @if(session()->get('language') == 'arabic') {{ $subcategory->subcat_name_ar }} @else {{ $subcategory->subcat_name_eng }} @endif
            </h2> </a>
            ...
            @endphp                
             ...
             @foreach($subsubcategories as $subsubcategory)         
               ...
               @if(session()->get('language') == 'arabic') {{ $subsubcategory->subsubcategory_name_ar }} @else {{ $subsubcategory->subsubcategory_name_eng }} @endif</a></li>
              ...
              <div class="item">
                <div class="products">
                  <div class="hot-deal-wrapper">
                    <div class="image"> <img src="{{ asset($htdl->product_thumbnail) }}" alt=""> </div>
                    @php
                    $discount = ($htdl->discount_price/$htdl->selling_price) * 100;
                    @endphp
                  ...
                  <div class="product-info text-left m-t-20">
                    <h3 class="name"><a href="detail.html">{{ $htdl->product_name_eng }}</a></h3>
                    <div class="rating rateit-small"></div>
                    @if($htdl->discount_price == NULL)
                    <div class="product-price"> <span class="price">${{ $htdl->selling_price }} </span> </div>
                    @else 
                    @php
                        $price = $htdl->selling_price - $htdl->discount_price;
                    @endphp
                    <div class="product-price"> <span class="price">${{ $price }} </span><span class="price-before-discount">${{ $htdl->selling_price }}</span> </div>
                    @endif                            <!-- /.product-price --> 
                        ...
                        <div class="row product-micro-row">
                          <div class="col col-xs-5">
                            <div class="product-image">
                              <div class="image"> <a href="#"> <img src="{{ asset($spcdl->product_thumbnail) }}" alt=""> </a> </div>
                              <!-- /.image --> 
                          ...
                          <div class="col col-xs-7">
                            <div class="product-info">
                              <h3 class="name"><a href="#">{{ $spcdl->product_name_eng }}</a></h3>
                              <div class="rating rateit-small"></div>
                  ...
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                    ...
                    <div class="item item-carousel">
                      <div class="products">
                        <div class="product">
                          <div class="product-image">
                            <div class="image"> <a href="detail.html"><img src="{{ asset($prd->product_thumbnail) }}" alt=""></a> </div>
                            <!-- /.image -->
                          ...
                          <div class="product-info text-left">
                            <h3 class="name"><a href="detail.html">{{ $prd->product_name_eng }}</a></h3>
                            <div class="rating rateit-small"></div>
                            ...
                            @else 
                            @php
                                $price = $prd->selling_price - $prd->discount_price;
                            @endphp
                            <div class="product-price"> <span class="price">${{ $price }} </span><span class="price-before-discount">${{ $prd->selling_price }}</span> </div>
                            @endif                            <!-- /.product-price --> 

...
@section('title')
{{ $products->product_name_eng }} | Product Details
@endsection
@section('content')
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>{{ $products->product_name_eng }}</li>
			</ul>
    ...
    <div class="product-info">
        ...
        <div class="stock-container info-container m-t-10">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="stock-box">
                        <span class="value">{{ $products->product_qty }} In Stock</span>
                    </div>	
                </div>
            </div><!-- /.row -->	
        </div><!-- /.stock-container -->
        ...
        <div class="description-container m-t-20">
            {{ $products->short_desc_eng }}        </div><!-- /.description-container -->
        ...
        <div class="price-container info-container m-t-20">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        @if($products->product_size_eng == null)
        ...
        <div class="tab-content">
            ...
            <div id="description" class="tab-pane in active">
                <div class="product-tab">
                    <p class="text"> {{ $products->short_desc_eng }}   </p>
                </div>	
            </div><!-- /.tab-pane -->
...
<div class="image">
    <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_eng ) }}"><img  src="{{ asset($product->product_thumbnail) }}" alt=""></a>
</div><!-- /.image -->			
...
<div class="product-info text-left">
    <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_eng ) }}">
        @if(session()->get('language') == 'english') {{ $product->product_name_eng }} @else {{ $product->product_name_ar }} @endif</a></h3><div class="rating rateit-small"></div>

 ...
 <form method="post" action="{{ route('subsubcategory.update') }}" >
	...
	<div class="controls">
		<select name="cat_id" class="form-control"  >
			...
			<option value="{{ $category->id }}" {{ $category->id == $subsubcategories->cat_id ? 'selected':'' }} >{{ $category->category_name_eng }}</option>	
			@endforeach
		</select>
		@error('cat_id') 
	...
	<div class="controls">
		<select name="subcategory_id" class="form-control"  >
			...
			<option value="{{ $subsub->id }}" {{ $subsub->id == $subsubcategories->subcategory_id ? 'selected':'' }} >{{ $subsub->subcat_name_eng }}</option>	
			@endforeach
		</select>
